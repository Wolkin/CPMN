	...
	<body>
		<div class="container-fluid">
				...
				<div class="span12">
					...
					<div class="row-fluid">
		                ...
		                <div class="block-area" id="responsiveTable">
		                    <h3 class="block-title">Betting information</h3>
            ...
            try {
        		...
        		String sSql = " select expect,user,redball1,redball2,redball3,redball4,redball5,redball6,blueball," + 
        					  " (case when isuse = 'Y' then '是' else '否' end) as isuse,inputdate " + 
        					  " from Betting_Record " + 
		        			  " where 1 = 1 " +
            ...
            %>
		                                <tr>
		                                    ...
		                                    <td><%=rs.getString("redball1") %></td>
		                                    <td><%=rs.getString("redball2") %></td>
		                                    <td><%=rs.getString("redball3") %></td>
		                                    <td><%=rs.getString("redball4") %></td>
		                                    <td><%=rs.getString("redball5") %></td>
		                                    <td><%=rs.getString("redball6") %></td>
		                                    <td><%=rs.getString("blueball") %></td>
		                                    <td><%=rs.getString("isuse") %></td>
